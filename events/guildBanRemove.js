...
module.exports = {
    ...
    async execute(ban) {
        try {
            ...
            let executor = null;
            let reason = LanguageManager.get(lang, 'events.common.none') || 'Aucune raison fournie';
            ...
            const embed = new EmbedBuilder()
                .setTitle(LanguageManager.get(lang, 'events.members.unbanned.title') || '🔓 Membre débanni')
                .setColor(0x00FF00)
                .addFields(
